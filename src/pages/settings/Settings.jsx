        ...
        <div className="rounded-xl border border-stone-200 bg-white p-4">
          ...
          {!isEditing ? (
            <div className="space-y-4">
                {data?.logo && (
                <div className="flex items-center gap-4 rounded-xl border border-stone-100 bg-stone-50 p-4">
                  <div className="relative shrink-0">
                    <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-br from-amber-400 via-orange-500 to-rose-400 opacity-30" />
                    <img
                      src={renderImage(data?.logo)}
                      width={60}
                      height={60}
                      className="relative rounded-xl object-cover border-2 border-white shadow-sm"
                      alt={'Logo'}
                    />
                  </div>
                  <div className="min-w-0">
                    <p className="text-xs font-semibold uppercase tracking-wider text-stone-400">
                      {t('settings.general.logo', 'Company Logo')}
                    </p>
